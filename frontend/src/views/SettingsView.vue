    ...
    <div class="settings-container">
      ...
      <section class="settings-section">
        ...
        <div class="setting-row">
          ...
          <div class="toggle-group">
            <button :class="['toggle-btn', { active: form.readingMode === 'normal' }]" @click="form.readingMode = 'normal'">Per Ayat</button>
            <button :class="['toggle-btn', { active: form.readingMode === 'mushaf' }]" @click="form.readingMode = 'mushaf'">Mushaf</button>
          </div>
        </div>
        ...
        <div class="setting-row">
          <div class="setting-info">
            ...
            <span class="setting-desc">Tampilkan sidebar daftar surah di desktop</span>
          </div>
          <label class="switch">
            <input type="checkbox" :checked="!form.sidebarCollapsed" @change="form.sidebarCollapsed = !$event.target.checked" />
      ...
      <section class="settings-section">
        ...
        <div class="setting-row">
          ...
          <label class="switch"><input type="checkbox" v-model="form.showTajweed" /><span class="slider"></span></label>
        </div>
        ...
        <div class="setting-row">
          ...
          <label class="switch"><input type="checkbox" v-model="form.showTranslation" /><span class="slider"></span></label>
        </div>

        <div v-if="form.showTranslation" class="setting-row sub">
          <div class="setting-info"><span class="setting-label">Sumber Terjemahan</span></div>
        ...
        <div class="setting-row">
          ...
          <label class="switch"><input type="checkbox" v-model="form.showWordByWord" /><span class="slider"></span></label>
        </div>
        ...
        <div class="setting-row">
          ...
          <label class="switch"><input type="checkbox" v-model="form.showTafsir" /><span class="slider"></span></label>
        </div>

        <div v-if="form.showTafsir" class="setting-row sub">
          <div class="setting-info"><span class="setting-label">Sumber Tafsir</span></div>
...
.setting-info { flex: 1; }
.setting-label { font-weight: 600; font-size: .9rem; color: var(--color-text); display: block; }
